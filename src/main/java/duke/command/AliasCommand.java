...
public class AliasCommand extends Command {
    ...
    public String[] execute(TaskList taskList, Storage storage) throws DukeException {
        ...
        Function<List<String>, ? extends Command> ctr = CommandCenter.getCommand(arguments.get(0));
        String[] params = CommandCenter.getParameters(arguments.get(0));
        ...
        return new String[]{
                "Ok, I have set \'" + arguments.get(1) + "\' as an alias."
        };
    }
}
